...
export default function AdminLoginPage() {
  ...
  useEffect(() => { if (isAdmin) setLocation("/admin"); }, [isAdmin, setLocation]);
    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      <div className="max-w-md w-full">
        <div className="glass-panel-heavy rounded-3xl p-8 border border-white/30">
          ...
          <h1 className="text-3xl font-serif text-blue-950 mb-2 text-center">Admin Access</h1>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-blue-900 mb-1">Admin Email</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/40 border border-white/40 text-blue-950 placeholder-blue-800/40 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
