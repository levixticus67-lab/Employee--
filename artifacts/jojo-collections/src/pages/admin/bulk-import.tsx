        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="glass-panel-heavy rounded-2xl p-6 border-white/50">
              ...
              <div className="mt-4 p-3 bg-blue-50/40 rounded-xl border border-blue-200/40">
                <p className="text-xs text-blue-900/70 leading-relaxed">
                  <strong>Tip:</strong> Wrap fields that contain commas in double quotes — e.g. <code className="font-mono">"Rose, Oud, Musk"</code>
                </p>
              </div>
            </div>
          </div>
