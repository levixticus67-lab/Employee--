      ...
      <footer className={`glass-panel mt-auto border-t border-white/10 py-10 relative z-10 ${user ? "pb-20 md:pb-10" : "pb-28 md:pb-10"}`}>
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="border-t border-white/10 pt-6 text-center">
            {(settings.instagramUrl || settings.tiktokUrl || settings.twitterUrl || whatsappUrl) && (
              <div className="flex items-center justify-center gap-5 mb-4">
                {settings.instagramUrl && (
                  <a href={settings.instagramUrl} target="_blank" rel="noopener noreferrer" title="Instagram"
                    className="text-sky-300/50 hover:text-sky-100 transition-colors">
                ...
                {whatsappUrl && (
                  <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" title="WhatsApp"
                    ...
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <path d="M12 0C5.374 0 0 5.373 0 12c0 2.117.55 4.107 1.513 5.838L.055 23.27a.75.75 0 00.91.912l5.41-1.458A11.944 11.944 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.003-1.368l-.36-.214-3.72 1.003 1.003-3.72-.214-.36A9.818 9.818 0 012.182 12C2.182 6.58 6.58 2.182 12 2.182c5.42 0 9.818 4.398 9.818 9.818 0 5.42-4.398 9.818-9.818 9.818z"/>
                    </svg>
                  </a>
                )}
              </div>
